...
// A scenario matrix for the code morph. DEMO BUILD.
//
...
const code = (content, lang = 'ts') => ({
  ...
  rotation: 0, opacity: 1, content, lang, color: '#DCE3EC', fontSize: 26, lineHeight: 1.55,
})
...
const doc = {
  ...
  present: { controls: false }, slides, modified: new Date().toISOString(),
}
