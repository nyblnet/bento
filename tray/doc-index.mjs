...
// contain. `tray/webext` answers them in JavaScript because it lives in a
// browser; `tray/android` answers them in Kotlin and `tray/ios` in Swift,
...
// reference, `tray/fixtures/` is the corpus, and `scripts/test-doc-index.mjs`
...
// in `tray/bridge.js` that are shared outright because a divergence there
// wrote users' documents out as zero bytes.
//
// Ported from tray/webext/src/library.js. If you change the algorithm, change
