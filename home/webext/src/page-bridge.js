...
//
// That is tray's contract (home/README.md), and it is why no web-side change is
...
;(() => {
  ...
  window.showSaveFilePicker = async (opts = {}) => {
    ...
    if (!claim?.ok) {
      ...
      console.info('[bento/home] not saving in place:', claim?.reason ?? 'no answer from the extension',
